...
final class Version20220605162859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        INSERT INTO `config` (`id`, `config_name`, `config_value`) VALUES (2,'SMTP USER','');
        INSERT INTO `config` (`id`, `config_name`, `config_value`) VALUES (3,'SMTP PASS','');
        INSERT INTO `config` (`id`, `config_name`, `config_value`) VALUES (4,'SMTP HOST','');
        INSERT INTO `config` (`id`, `config_name`, `config_value`) VALUES (5,'SMTP PORT','');
        INSERT INTO `config` (`id`, `config_name`, `config_value`) VALUES (6,'SMTP PROTOCOL','');
